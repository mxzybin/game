...
* [Node JS](https://nodejs.org/) - install the latest recommended version(**minimal version is 12.13**)

If you have Node JS already installed, please check version and make sure it is 12.13+:
* `node -v` - **If your version is earlier than 12.13 - upgrade your Node JS**
